...
#     Output('chartEditor', 'loadFigure'),
#     Input('template', 'value'),
#     Input('chartEditor', 'data'),
#     Input('chartEditor', 'layout'),
#     Input('chartEditor','frames')
# )
# def setTemplate(v, d, l, f):
#     if v:
#         newFig = {'data': d, 'layout':l, 'frames': f}
#         newFig['layout'].update({'template': pio.templates[v]})
#         return newFig
#     return no_update
#
#
