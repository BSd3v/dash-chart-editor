...
import {TRACE_TO_AXIS} from 'react-chart-editor/lib/lib/constants';
import CustomSubplotAccordion from './CustomSubplotAccordion';

const CustomGraphSubplotsPanel = (props, {localize: _}) => (
    <CustomSubplotAccordion>
...
CustomGraphSubplotsPanel.contextTypes = {
    localize: PropTypes.func,
};

export default CustomGraphSubplotsPanel;
